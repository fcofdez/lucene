 ...
 * and index the field for fast range filters. If you also need to store the value, you
 * should add a separate {@link StoredField} instance. If you need more fine-grained control you
 * can use {@link IntPoint} and {@link NumericDocValuesField} or {@link SortedNumericDocValuesField}.
 *
